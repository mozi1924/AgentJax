//! Core data types for the RAG (Retrieval-Augmented Generation) system.
//!
//! These are generic retrieval types used by the vector store, FTS store,
//! and chunking engine. KB-specific types live in `crate::knowledge_base::types`.
