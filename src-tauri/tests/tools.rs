use app_lib::agentjax_home::AGENTJAX_HOME_ENV;
    ...
    async fn test_tool_catalog_snapshot_freezes_native_tool_view() {
        ...
        // Context: llm_map + 3 LCM + 4 KB + _archived_tool = 9
        //   (memory search/recall gated by MemoryEnabled, write gated by
        //    MemorySubAgentOnly — all disabled under default config)
        // Total: 9 + 10 = 19
